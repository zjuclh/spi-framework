...
import com.lingyun.components.spring.biz.core.spi.QueryReceiverInfo;
import org.springframework.stereotype.Component;

/**
 * @author caolianghong
 * @date 2022/8/11 3:38 下午
 */
@Component
public class DefaultQueryReceiverInfo implements QueryReceiverInfo {
    @Override
    ...
    public void execute(SettleContext bizContext) {
        System.out.println("|--DefaultQueryReceiverInfo success");
    }
}
